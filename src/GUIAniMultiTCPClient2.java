...
class GUIAniMultiTCPClient2 {
    ...
    public static void main(String[] args) {
        ...
        GUIAniMultiTCPClient2 gui = new GUIAniMultiTCPClient2();

        gui.doClientAccess(hostname, "face,place,0,100,200");
        gui.sleep5();
        gui.doClientAccess(hostname, "face,color,1,yellow");
        gui.sleep5();
        gui.doClientAccess(hostname, "face,emotion,0,angry");
        gui.sleep5();
        ...
        while (true) {
            try {
                ...
                gui.doClientAccess(hostname, "commandfromClient");
    ...
    GUIAniMultiTCPClient2() {// コンストラクター
        ...
        System.out.println("face,emotion,0,angry");
        System.out.println("face,emotion,0,normal");
    }
}